...
public void setup(String browser ) {
  ...
  public void addToken() {
    ...
    @Test(priority=2)
    public void addTFard() {
    	
    	 WebDriverWait mFard = new WebDriverWait(driver, Duration.ofSeconds(20));
  		mFard.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[contains(text(),'تفصیلی فرد')])[1]"))).click();   
	...
	wait7.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[@id='accountNumberId'])[1]"))).click();
   
	WebDriverWait wait8 = new WebDriverWait(driver, Duration.ofSeconds(20));
	wait8.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[contains(@type,'button')])[4]"))).click();
	
	WebDriverWait wait81 = new WebDriverWait(driver, Duration.ofSeconds(20));
	wait81.until(ExpectedConditions.elementToBeClickable(By.xpath("(//td[contains(@data-label,'انتخاب کریں')])[1]"))).click();
